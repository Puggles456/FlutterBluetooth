          ...
          if (characteristic.uuid == Guid(characteristicNotifyUuid) &&
            ...
            characteristic.value.listen((value) {
             ...
             /*
              ...
              debugPrint('TDCBleManager data: $hexString');
              */
...
Future<void> sendCommand(BluetoothCharacteristic characteristic) async {
  try {
    ...
    //debugPrint("sendData.length: ${commandData.length}");
    //debugPrint(
      //  "sendData: ${commandData.map((byte) => byte.toRadixString(16).padLeft(2, '0')).join(' ')}");
  } catch (e) {
